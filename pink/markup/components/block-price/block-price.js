...
// ----------------------------------------------
const blockPriceCanvas = document.querySelector( '.price__canvas' );
const blockPriceCanvasContext = blockPriceCanvas.getContext( '2d' );
// ----------------------------------------------
// DRAW TRIANGLE TOP
// ----------------------------------------------
...
window.addEventListener( 'load', function () {
    variablesValues();
    stylingTop( blockPriceCanvas );
    drawTriangleTop( blockPriceCanvasContext, primaryColor );
}, false );
