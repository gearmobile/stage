...
let width;
let height;
const aspectRatio = 0.049;
// ----------------------------------------------
// SECTION INFORMATION ELEMENTS
// ----------------------------------------------
const blockContactsCanvas = document.querySelector( '.contacts__canvas' );
const blockContactsCanvasContext = blockContactsCanvas.getContext( '2d' );
// ----------------------------------------------
// DRAW TRIANGLE TOP
// ----------------------------------------------
function drawTriangleTop( topCanvasContext, color ) {
    ...
    topCanvasContext.lineTo( width / 2, height );
...
function stylingTop( blockTopCanvas ) {
    ...
    blockTopCanvas.style.zIndex = 4;
    blockTopCanvas.style.left = 0 + 'px';
    blockTopCanvas.style.bottom = -height + 'px';
...
window.addEventListener( 'load', function () {
    variablesValues();
    stylingTop( blockContactsCanvas );
    drawTriangleTop( blockContactsCanvasContext, primaryColor );
}, false );
